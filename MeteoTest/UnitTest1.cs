...
namespace MeteoTest
{
    public class UnitTest1
    {
        ...
        public void ConstructorTest_ShouldBeEqual()
        {
            ...
            //Execution
            MeteoViewModel mvm = new MeteoViewModel(_regionDbMock.Object, _apiClientMock.Object);
        ...
        [Fact]
        public async void GetMeteoTest_ShouldBeEqual()
        {
            //Setup
            _regionDbMock.Setup(rdr => rdr.GetAll()).Returns(ListeAttendues());
            _apiClientMock.Setup(acm => acm.RequeteGetAsync(It.IsAny<String>())).Returns(() => Task.FromResult(JsonAttendu()));
            ...
            //Execution
            await mvm.GetMeteo(new Region(1, "Shawinigan", 12.123, -12.123)); // Region pas rapport juste pour tester
